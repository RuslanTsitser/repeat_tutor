    ...
    return Column(
      children: [
        if (onPrevious != null) ...[
          SafeArea(
            bottom: false,
            child: SuccessBackButton(onPrevious: onPrevious!),
          ),
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: SuccessButton(onNext: onNext),
                ),
              ],
            ),
          ),
...
class SuccessIllustration extends StatelessWidget {
  ...
  static const double _starSize = 120.0;
  static const double _starIconSize = 64.0;
  static const double _smallStarSize = 32.0;
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            top: 16.0,
            left: 32.0,
            child: _buildSmallStar(delay: 200.ms),
          ),
          Positioned(
            top: 16.0,
            right: 32.0,
            child: _buildSmallStar(delay: 400.ms),
          ),
          Positioned(
            bottom: 16.0,
            left: 32.0,
            child: _buildSmallStar(delay: 600.ms),
          ),
          Positioned(
            bottom: 16.0,
            right: 32.0,
            child: _buildSmallStar(delay: 800.ms),
          ),
        ],
      ),
    );
  ...
  Widget _buildSmallStar({Duration delay = Duration.zero}) {
    return Icon(
          LucideIcons.star,
...
class SuccessBackButton extends StatelessWidget {
  final VoidCallback onPrevious;

  const SuccessBackButton({
    super.key,
